<x-app-layout>
    <x-slot name="breadcrumb">
        ...
        <div class="breadcrumb-item">
            ...
            <a href="{{ route('logistik.approval.index') }}">Persetujuan Peminjaman</a>
        </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="teluroom-card mb-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    @if ($reservasi->catatan_ssc)
                        <div class="mb-2">
                            <span class="text-secondary d-block mb-2" style="font-size: 0.8125rem; font-weight: 600;">CATATAN VERIFIKASI SSC</span>
                            <div class="p-3 rounded text-dark" style="font-size: 0.875rem; background-color: #f8f9fa; border-left: 3px solid #6b7280;">
            ...
            <a href="{{ route('logistik.approval.index') }}" class="btn btn-light border px-4 d-inline-flex align-items-center" style="height: 48px;">
        ...
        {{-- Kanan: Panel Persetujuan (30%) --}}
        <div class="col-lg-4">
            @if ($reservasi->status === 'menunggu_logistik')
                <div class="teluroom-card border-dark shadow-sm">
                    <div class="card-body p-4">
                        <h5 class="fw-bold text-dark mb-4 pb-3 border-bottom">Panel Persetujuan</h5>

                        <form method="POST" action="{{ route('logistik.approval.process', $reservasi) }}" id="formApproval" novalidate>
                            @csrf
                            <input type="hidden" name="action" id="actionInput">

                            <div class="mb-4">
                                <label for="catatan_logistik" class="form-label">Catatan Logistik</label>
                                <textarea name="catatan_logistik" id="catatan_logistik" rows="4"
                                    class="form-control teluroom-input @error('catatan_logistik') is-invalid @enderror"
                                    placeholder="Wajib jika ditolak (Opsional jika disetujui)">{{ old('catatan_logistik') }}</textarea>
                            ...
                            <div class="d-flex flex-column gap-2">
                                <button type="button" class="btn btn-dark w-100 d-flex justify-content-center align-items-center" style="height: 48px;"
                                    ...
                                    data-message="QR Code peminjaman akan dibuat secara otomatis. Lanjutkan?"
                                    data-btn-class="btn-dark"
                                    data-btn-text="Setujui Pengajuan">
            ...
            @else
                <div class="teluroom-card bg-light border-0">
                    <div class="card-body p-4">
                        <h5 class="fw-bold text-dark mb-3">Status Persetujuan</h5>
                        <p class="text-secondary" style="font-size: 0.875rem;">Pengajuan ini sudah ditutup dan tidak memerlukan tindakan lebih lanjut.</p>
