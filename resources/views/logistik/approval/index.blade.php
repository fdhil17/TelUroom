<x-app-layout>
    <x-slot name="header">
        <h2 class="fs-4 fw-bold text-dark">Persetujuan Peminjaman Ruang</h2>
    </x-slot>
    ...
    <div class="container py-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('logistik.approval.index') }}" class="row g-2 align-items-end">
                    <div class="col-md-4">
                        ...
                        <tbody>
                            ...
                            @forelse ($reservasis as $reservasi)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('logistik.approval.show', $reservasi) }}" class="btn btn-sm btn-outline-primary">Detail</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
