<x-app-layout>
    <x-slot name="header">
        <h2 class="fs-4 fw-bold text-dark">{{ __('dashboard.mahasiswa_judul') }}</h2>
    </x-slot>
    ...
    <div class="container py-4">
        ...
        <div class="row mb-4">
            <div class="col-md-3 mb-3">
                <div class="card stat-card text-center stat-primary">
                    <div class="card-body">
                        <h3 class="fw-bold">{{ $statistik['total'] }}</h3>
            ...
            <div class="col-md-3 mb-3">
                <div class="card stat-card text-center stat-warning">
                    <div class="card-body">
                        <h3 class="fw-bold">{{ $statistik['menunggu_ssc'] + $statistik['menunggu_logistik'] }}</h3>
            ...
            <div class="col-md-3 mb-3">
                <div class="card stat-card text-center stat-danger">
                    <div class="card-body">
                        <h3 class="fw-bold">{{ $statistik['ditolak'] }}</h3>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('mahasiswa.reservasi.index') }}" class="btn btn-outline-primary mt-2">{{ __('dashboard.lihat_semua_pengajuan') }}</a>
            </div>
        </div>
